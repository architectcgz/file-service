package com.architectcgz.file.application.service.direct.storage;
...
public class DirectUploadStorageService {
    ...
    public List<S3StorageService.PartInfo> fetchUploadedPartInfos(UploadTask task, String bucketName) {
        return s3StorageService.listUploadedPartsWithETag(task.getStoragePath(), task.getUploadId(), bucketName);
    }

    public String generatePresignedUploadPartUrl(String storagePath,
                                                 String uploadId,
                                                 int partNumber,
                                                 int expireSeconds,
                                                 String bucketName) {
        return s3StorageService.generatePresignedUploadPartUrl(
                storagePath,
                uploadId,
                partNumber,
                expireSeconds,
    ...
    public String getPublicUrl(String bucketName, String storagePath) {
        return s3StorageService.getPublicUrl(bucketName, storagePath);
    }
